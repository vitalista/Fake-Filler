(function () {
  ...
  document.getElementById("fillBtn").addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      switch (input.type) {
        ...
        case "number":
          if (input.hasAttribute('maxlength')) {
            ...
            var randomNum = Math.floor(Math.random() * Math.pow(10, maxLength));
          ...
          break;
        case "date":
          valueToSet = new Date(Date.now() + Math.floor(Math.random() * 1e10)).toISOString().split("T")[0];
          break;
        case "color":
        ...
        case "url":
          ...
          break;
        case "datetime-local":
          valueToSet = new Date(Date.now() + Math.floor(Math.random() * 1e10)).toISOString().slice(0, 16);
          break;
        case "time":
          valueToSet = new Date(Date.now() + Math.floor(Math.random() * 1e10)).toISOString().slice(11, 16);
          break;
        case "month":
          valueToSet = new Date(Date.now() + Math.floor(Math.random() * 1e10)).toISOString().slice(0, 7);
          break;
        case "hidden":
          return;
        case "password":
        ...
        case "week":
          ...
          var randomWeek = Math.floor(Math.random() * 52) + 1;
          valueToSet = "".concat(currentYear, "-W").concat(randomWeek.toString().padStart(2, "0"));
          break;
        case "range":
